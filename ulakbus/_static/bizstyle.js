...
$(window).resize(function(){
    if ($(window).width() <= 776) {
        ...
        $("div.related:first ul li:not(.right):first a").text("Ulakbus API Documentation 0.0.4 belgelendirme çalışması");
        $("div.related:last  ul li:not(.right):first a").text("Ulakbus API Documentation 0.0.4 belgelendirme çalışması");
    }
});